    ...
    <div class="col-md-12">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <a href="{$_url}contacts/import_csv/" class="btn btn-xs btn-primary btn-rounded pull-right"><i class="fa fa-upload"></i> Importar</a>
                ...
                <form class="form-horizontal" id="rform">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group"><label class="control-label" for="account">{$_L['Full Name']}*</label>
                            ...
                            <div class="form-group"><label class="control-label" for="email">{$_L['Email']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="password">{$_L['Password']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="address">{$_L['Address']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="state">{$_L['State Region']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="zip">{$_L['ZIP Postal Code']} </label>
                            ...
                            {foreach $fs as $f}
                                <div class="form-group"><label class="control-label" for="cf{$f['id']}">{$f['fieldname']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="tags">{$_L['Tags']}</label>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group"><label class="control-label" for="company">{$_L['Company Name']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="phone">{$_L['Phone']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="cpassword">{$_L['Confirm Password']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="city">{$_L['City']}</label>
                            ...
                            <div class="form-group"><label class="control-label" for="country">{$_L['Country']}</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                    <button class="md-btn md-btn-primary" type="submit" id="submit"> {$_L['Save']}</button>
                            </div>
                        </div>
                    </div>
