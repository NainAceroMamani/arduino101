...
<form class="form-horizontal" id="rform">
    ...
    <div class="form-group"><label class="control-label" for="account">{$_L['Account Name']}</label>
    ...
    <div class="form-group"><label class=" control-label" for="edit_email">{$_L['Email']}</label>
    ...
    <div class="form-group"><label class=" control-label" for="group">{$_L['Group']} </label>
