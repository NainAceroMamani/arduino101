            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="{$_url}reports/statement-view" id="tform" role="form">
                    <div class="form-group">
                        <label for="description" class="control-label m-r-md">{$_L['Account']}</label>
                    ...
                    <div class="form-group">
                        <label for="fdate" class="control-label">{$_L['From Date']}</label>
                    ...
                    <div class="form-group">
                        <label for="tdate" class="control-label">{$_L['To Date']}</label>
                    ...
                    <div class="form-group">
                        <label for="stype" class="control-label">{$_L['Type']}</label>
                    ...
                    <div class="form-group">
                        <div>
                            <button type="submit" id="submit" class="btn btn-primary">Ver Estado</button>
                        </div>
                    </div>
                </form>
