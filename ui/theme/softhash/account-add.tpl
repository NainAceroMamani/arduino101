    ...
    <div class="col-md-6">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form role="form" class="form-horizontal" name="accadd" method="post" action="{$_url}accounts/add-post">
                    <div class="form-group">
                        <label class="control-label" for="account">{$_L['Account Title']}*</label>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="balance">{$_L['Initial Balance']}</label>
