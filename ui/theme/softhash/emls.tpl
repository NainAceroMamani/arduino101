    ...
    <div class="col-md-6">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form role="form" name="eml" method="post" action="{$_url}settings/eml-post" class="form-horizontal">


                    <div class="form-group">
                        <label class="control-label" for="theme">{$_L['Send Email Using']}</label>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="sysemail">{$_L['System Email']}</label>
